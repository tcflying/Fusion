...
export const ROOM_CONTROLLER_EVENT_TYPES = [
  ...
  "message_routed",
  "task_graph_changed",
  "room_task_dispatch_claimed",
  "room_task_dispatch_delivery_rejected",
  "room_task_dispatch_delivery_uncertain_blocked",
  ...
  "room_semantic_state_updated",
  "room_protocol_message_routed",
  "room_semantic_controller_action_claimed",
  "room_semantic_controller_action_completed",
  "protocol_changed",
  "turn_checkpointed",
  "outbox_enqueued",
