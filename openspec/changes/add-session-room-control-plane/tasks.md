...
- [x] 4.4 Implement routed operator messages to controller, all, group, or selected seats using structured authority envelopes and durable target records.
...
- [x] 4.7 Inject crashes after command commit, after external send, before acknowledgement, and during takeover; prove recovery or visible uncertainty with no silent loss.
...
- [x] 5.2 Implement dynamic hierarchical DAG commands and projections, including add/split/merge/cancel/reopen with causal evidence.
...
- [x] 5.4 Implement initial analysis, implementation, diagnosis, creative-review, and bounded-discussion protocol definitions with migration/version tests.
